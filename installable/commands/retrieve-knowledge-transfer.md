You are helping the user restore their project context from a standardized knowledge transfer package after Claude Code's automatic compaction. These files may have been generated by either the traditional sequential approach or the new parallel sub-agent approach.
